        ...
        switch (indexQuestionType){
            case 0:
                ...
                if(allAnimeSongDetailsList[indexRandAnime][1][indexRandSong].type === 3) {
                    sendChatMessage("In what anime is the insert song \""+allAnimeSongDetailsList[indexRandAnime][1][indexRandSong].title+"\" from the artist \""+allAnimeSongDetailsList[indexRandAnime][1][indexRandSong].artist+"\"");
                }
                else {
                    if (allAnimeSongDetailsList[indexRandAnime][1][indexRandSong].number === 1){
                        sendChatMessage("In what anime is the 1st "+songType[allAnimeSongDetailsList[indexRandAnime][1][indexRandSong].type-1]+" song \""+allAnimeSongDetailsList[indexRandAnime][1][indexRandSong].title+"\" from the artist \""+allAnimeSongDetailsList[indexRandAnime][1][indexRandSong].artist+"\"");
                    }
                    else if (allAnimeSongDetailsList[indexRandAnime][1][indexRandSong].number === 2){
                        sendChatMessage("In what anime is the 2nd "+songType[allAnimeSongDetailsList[indexRandAnime][1][indexRandSong].type-1]+" song \""+allAnimeSongDetailsList[indexRandAnime][1][indexRandSong].title+"\" from the artist \""+allAnimeSongDetailsList[indexRandAnime][1][indexRandSong].artist+"\"");
                    }
                    else if (allAnimeSongDetailsList[indexRandAnime][1][indexRandSong].number === 3){
                        sendChatMessage("In what anime is the 3rd "+songType[allAnimeSongDetailsList[indexRandAnime][1][indexRandSong].type-1]+" song \""+allAnimeSongDetailsList[indexRandAnime][1][indexRandSong].title+"\" from the artist \""+allAnimeSongDetailsList[indexRandAnime][1][indexRandSong].artist+"\"");
                    }
                    else {
                        sendChatMessage("In what anime is the "+allAnimeSongDetailsList[indexRandAnime][1][indexRandSong].number+"th "+songType[allAnimeSongDetailsList[indexRandAnime][1][indexRandSong].type-1]+" song \""+allAnimeSongDetailsList[indexRandAnime][1][indexRandSong].title+"\" from the artist \""+allAnimeSongDetailsList[indexRandAnime][1][indexRandSong].artist+"\"");
                    }
                }
            ...
            case 1:
                ...
                if (allAnimeSongDetailsList[indexRandAnime][1][indexRandSong].type === 3) {
                    sendChatMessage("What is the name of the insert song appearing in\""+allAnimeSongDetailsList[indexRandAnime][0]+"\" from the artist \""+allAnimeSongDetailsList[indexRandAnime][1][indexRandSong].artist+"\"");
                }
                else {
                    if (allAnimeSongDetailsList[indexRandAnime][1][indexRandSong].number === 1){
                        sendChatMessage("What is the name of the 1st "+songType[allAnimeSongDetailsList[indexRandAnime][1][indexRandSong].type-1]+" song appearing in the anime \""+allAnimeSongDetailsList[indexRandAnime][0]+"\" from the artist \""+allAnimeSongDetailsList[indexRandAnime][1][indexRandSong].artist+"\"");
                    }
                    else if (allAnimeSongDetailsList[indexRandAnime][1][indexRandSong].number === 2) {
                        sendChatMessage("What is the name of the 2nd "+songType[allAnimeSongDetailsList[indexRandAnime][1][indexRandSong].type-1]+" song appearing in the anime \""+allAnimeSongDetailsList[indexRandAnime][0]+"\" from the artist \""+allAnimeSongDetailsList[indexRandAnime][1][indexRandSong].artist+"\"");
                    }
                    else if (allAnimeSongDetailsList[indexRandAnime][1][indexRandSong].number === 3) {
                        sendChatMessage("What is the name of the 3rd "+songType[allAnimeSongDetailsList[indexRandAnime][1][indexRandSong].type-1]+" song appearing in the anime \""+allAnimeSongDetailsList[indexRandAnime][0]+"\" from the artist \""+allAnimeSongDetailsList[indexRandAnime][1][indexRandSong].artist+"\"");
                    }
                    else {
                        sendChatMessage("What is the name of the "+allAnimeSongDetailsList[indexRandAnime][1][indexRandSong].number+"th "+songType[allAnimeSongDetailsList[indexRandAnime][1][indexRandSong].type-1]+" song appearing in the anime \""+allAnimeSongDetailsList[indexRandAnime][0]+"\" from the artist \""+allAnimeSongDetailsList[indexRandAnime][1][indexRandSong].artist+"\"");
                    }
                }
            ...
            case 2:
                ...
                if (allAnimeSongDetailsList[indexRandAnime][1][indexRandSong].type === 3) {
                    sendChatMessage("In \""+allAnimeSongDetailsList[indexRandAnime][0]+"\", what is the name of the artist credited in the insert song \""+allAnimeSongDetailsList[indexRandAnime][1][indexRandSong].title+"\"?");
                }
                else {
                    if (allAnimeSongDetailsList[indexRandAnime][1][indexRandSong].number === 1){
                        sendChatMessage("In \""+allAnimeSongDetailsList[indexRandAnime][0]+"\", what is the name of the artist credited in the 1st "+songType[allAnimeSongDetailsList[indexRandAnime][1][indexRandSong].type-1]+" song \""+allAnimeSongDetailsList[indexRandAnime][1][indexRandSong].title+"\?");
                    }
                    else if (allAnimeSongDetailsList[indexRandAnime][1][indexRandSong].number === 2) {
                        sendChatMessage("In \""+allAnimeSongDetailsList[indexRandAnime][0]+"\", what is the name of the artist credited in the 2nd "+songType[allAnimeSongDetailsList[indexRandAnime][1][indexRandSong].type-1]+" song \""+allAnimeSongDetailsList[indexRandAnime][1][indexRandSong].title+"\?");
                    }
                    else if (allAnimeSongDetailsList[indexRandAnime][1][indexRandSong].number === 3) {
                        sendChatMessage("In \""+allAnimeSongDetailsList[indexRandAnime][0]+"\", what is the name of the artist credited in the 3rd "+songType[allAnimeSongDetailsList[indexRandAnime][1][indexRandSong].type-1]+" song \""+allAnimeSongDetailsList[indexRandAnime][1][indexRandSong].title+"\?");
                    }
                    else {
                        sendChatMessage("In \""+allAnimeSongDetailsList[indexRandAnime][0]+"\", what is the name of the artist credited in the "+allAnimeSongDetailsList[indexRandAnime][1][indexRandSong].number+"th "+songType[allAnimeSongDetailsList[indexRandAnime][1][indexRandSong].type-1]+" song \""+allAnimeSongDetailsList[indexRandAnime][1][indexRandSong].title+"\?");
                    }
                }
